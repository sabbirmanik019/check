...
} elseif ($_instance->childHasBeenRendered('XG8FCFQ')) {
    $componentId = $_instance->getRenderedChildComponentId('XG8FCFQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('XG8FCFQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XG8FCFQ');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('XG8FCFQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('m7L9mAJ')) {
    $componentId = $_instance->getRenderedChildComponentId('m7L9mAJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('m7L9mAJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('m7L9mAJ');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('m7L9mAJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script src="https://anyework.com/wireui/assets/scripts?id=3c15fb3b36f54e2baae1e97b6eb0015e" defer ></script>
...
</html><?php /**PATH /home/sabbirmanik/anyework.com/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>