                        ...
                        <div class="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-2 sm:gap-4 sm:px-6">
                            ...
                            <dd class="mt-1 text-xs font-bold text-gray-900 sm:mt-0">
                               <?php switch($order->invoice->payment_method):
                                   case ('balance'): ?>
                                       <span><?php echo e(__('messages.t_user_credit'), false); ?></span>
                                       <?php break; ?>
                                   <?php case ('paypal'): ?>
                                       <span class="text-[#3b7bbf]"><?php echo e(__('messages.t_paypal'), false); ?></span>
                                       <?php break; ?>
                                    <?php case ('stripe'): ?>
                                       <span class="text-[#008cdd]"><?php echo e(__('messages.t_stripe'), false); ?></span>
                                       <?php break; ?>
                                    <?php case ('offline'): ?>
                                       <span class="text-gray-500"><?php echo e(settings('offline_payment')->name, false); ?></span>
                                       <?php break; ?>
                                    <?php case ('paystack'): ?>
                                       <span class="text-gray-500"><?php echo e(settings('paystack')->name, false); ?></span>
                                       <?php break; ?>
                                    <?php case ('cashfree'): ?>
                                       <span class="text-gray-500"><?php echo e(settings('cashfree')->name, false); ?></span>
                                       <?php break; ?>
                                    <?php case ('xendit'): ?>
                                       <span class="text-gray-500"><?php echo e(settings('xendit')->name, false); ?></span>
                                       <?php break; ?>
                                   <?php default: ?>
...
<?php /**PATH /home/sabbirmanik/anyework.com/resources/views/livewire/admin/orders/options/details.blade.php ENDPATH**/ ?>