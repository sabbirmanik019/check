    ...
    <div class="w-full">
        ...
        <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg py-5 mb-6 dark:bg-zinc-800">
            ...
            <div class="mx-auto max-w-3xl px-4 sm:px-6 md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-8">
                <div class="flex items-center space-x-5 rtl:space-x-reverse flex-col md:flex-row">
                    ...
                    <div>
                            ...
                            <div class="flex items-center space-x-2 rtl:space-x-reverse mb-4 md:mb-0 justify-center md:justify-normal space-y-1 md:space-y-0 flex-col md:flex-row">
                ...
                <div class="flex items-center space-x-2 rtl:space-x-reverse justify-center md:justify-normal">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->id() != $user->id && $user->account_type === 'seller'): ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-6 gap-y-6">
            ...
            <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg dark:bg-zinc-800 divide-y dark:divide-zinc-700 space-y-8 h-fit pb-8">
                ...
                <section class="px-5 pt-8">
                    ...
                    <ul class="list-disc list-inside text-gray-500 dark:text-zinc-300 text-sm space-y-3">

                        
                        <?php if($user->headline): ?>
                            <li>
                                <div class="inline-flex items-center space-x-1 rtl:space-x-reverse absolute">
                                    <div>
                        ...
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <div class="flex flex-col w-full gap-4 pt-6">
                                ...
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_5_stars'); ?></label>
                                ...
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_4_stars'); ?></label>
                                ...
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_3_stars'); ?></label>
                                ...
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_2_stars'); ?></label>
                                ...
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex"><?php echo app('translator')->get('messages.t_1_star'); ?></label>
            ...
            <div class="-mx-6 -my-6 pb-8 pt-10 relative">
                <div class="flex flex-col items-center px-4">
                    ...
                    <div>
                        ...
                        ?>
                        <?php echo QrCode::backgroundColor(0,0,0,0)->color($qr_code_color, $qr_code_color, $qr_code_color)->size(100)->generate(url('profile', $user->username)); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sabbirmanik/anyework.com/resources/views/livewire/main/profile/profile.blade.php ENDPATH**/ ?>