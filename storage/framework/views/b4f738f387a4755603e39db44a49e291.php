...
} elseif ($_instance->childHasBeenRendered('DBWXOy7')) {
    $componentId = $_instance->getRenderedChildComponentId('DBWXOy7');
    $componentTag = $_instance->getRenderedChildComponentTagName('DBWXOy7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DBWXOy7');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('DBWXOy7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('wdxXL9D')) {
    $componentId = $_instance->getRenderedChildComponentId('wdxXL9D');
    $componentTag = $_instance->getRenderedChildComponentTagName('wdxXL9D');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wdxXL9D');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('wdxXL9D', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home/updaxrzy/anyework.com/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>