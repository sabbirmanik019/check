        ...
        <nav class="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 justify-between items-center h-20 flex">
            ...
            <div class="w-full hidden lg:block">   
                <div class="relative max-w-md" x-data="{ open: false }">
                    ...
                    <input wire:model.debounce.500ms="q" wire:keydown.enter="enter" x-ref="search" x-on:click="open = true" type="search" class="block p-2.5 w-full z-20 text-sm text-gray-900 dark:text-white bg-white dark:bg-[#181818] rounded border border-gray-300 dark:border-[#181818] focus:ring-0 focus:border-gray-500" placeholder="<?php echo e(__('messages.t_what_service_are_u_looking_for_today'), false); ?>" required>
...
} elseif ($_instance->childHasBeenRendered('l1818993534-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l1818993534-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1818993534-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1818993534-0');
} else {
    $response = \Livewire\Livewire::mount('main.partials.languages');
    $html = $response->html();
    $_instance->logRenderedChild('l1818993534-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l1818993534-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l1818993534-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1818993534-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1818993534-1');
} else {
    $response = \Livewire\Livewire::mount('main.partials.search');
    $html = $response->html();
    $_instance->logRenderedChild('l1818993534-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l1818993534-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l1818993534-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l1818993534-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l1818993534-2');
} else {
    $response = \Livewire\Livewire::mount('main.partials.cart');
    $html = $response->html();
    $_instance->logRenderedChild('l1818993534-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="inline-block flex-shrink-0 border-b-2 border-transparent hover:border-primary-600 focus:outline-none focus:ring-0 relative">
                        ...
                        <?php if(count($category->subcategories)): ?>
                            <button data-popover-target="popover-subcategories-<?php echo e($category->uid, false); ?>" data-popover-trigger="hover" class="block text-[13px] font-medium text-gray-700 dark:text-gray-300 dark:group-hover:text-white group-hover:text-primary-600 py-2 focus:outline-none focus:ring-0">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/sabbirmanik/anyework.com/resources/views/livewire/main/includes/header.blade.php ENDPATH**/ ?>