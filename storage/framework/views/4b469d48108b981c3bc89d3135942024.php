...
} elseif ($_instance->childHasBeenRendered('C9w8xFa')) {
    $componentId = $_instance->getRenderedChildComponentId('C9w8xFa');
    $componentTag = $_instance->getRenderedChildComponentTagName('C9w8xFa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C9w8xFa');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('C9w8xFa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('zdqSPT6')) {
    $componentId = $_instance->getRenderedChildComponentId('zdqSPT6');
    $componentTag = $_instance->getRenderedChildComponentTagName('zdqSPT6');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zdqSPT6');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('zdqSPT6', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/sabbirmanik/anyework.com/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>