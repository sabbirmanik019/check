                        ...
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-messages-<?php echo e($msg->id, false); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md object-cover lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($msg->from->avatar), false); ?>" alt="<?php echo e($msg->from->username, false); ?>">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md object-cover lazy" src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($msg->to->avatar), false); ?>" alt="<?php echo e($msg->to->username, false); ?>">
                                    <div class="space-y-1 font-medium dark:text-white">
                                        <div class="flex items-center space-x-1 rtl:space-x-reverse">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-view-container-'.e($msg->id, false).'','target' => 'modal-view-button-'.e($msg->id, false).'','uid' => 'modal_msg_details_'.e($msg->id, false).'','placement' => 'center-center','size' => 'max-w-xl']); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/sabbirmanik/anyework.com/resources/views/livewire/admin/conversations/conversations.blade.php ENDPATH**/ ?>