...
} elseif ($_instance->childHasBeenRendered('wtgUSEt')) {
    $componentId = $_instance->getRenderedChildComponentId('wtgUSEt');
    $componentTag = $_instance->getRenderedChildComponentTagName('wtgUSEt');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wtgUSEt');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('wtgUSEt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('zWa9YC5')) {
    $componentId = $_instance->getRenderedChildComponentId('zWa9YC5');
    $componentTag = $_instance->getRenderedChildComponentTagName('zWa9YC5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zWa9YC5');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('zWa9YC5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/updaxrzy/anyework.com/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>