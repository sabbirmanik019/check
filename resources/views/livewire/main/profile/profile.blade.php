        ...
        <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg py-5 mb-6 dark:bg-zinc-800">
            ...
            <div class="mx-auto max-w-3xl px-4 sm:px-6 md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-8">
                ...
                <div class="flex items-center space-x-2 rtl:space-x-reverse justify-center md:justify-normal">
                    ...
                    {{-- Send custom offer --}}
                    @auth
                        @if (auth()->id() != $user->id && $user->account_type === 'seller')
                        ...
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <div class="flex flex-col w-full gap-4 pt-6">
                                ...
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_5_stars')</label>
                                ...
                                {{-- 4 star --}}
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_4_stars')</label>
                                ...
                                {{-- 3 star --}}
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_3_stars')</label>
                                ...
                                {{-- 2 star --}}
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_2_stars')</label>
                                ...
                                {{-- 1 star --}}
                                <span class="flex items-center w-full gap-2">
                                    <label class="mb-0 text-xs text-center w-9 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_1_star')</label>
            ...
            <div class="-mx-6 -my-6 pb-8 pt-10 relative">
                <div class="flex flex-col items-center px-4">
                    ...
                    <div>
                        ...
                        @endphp
                        {!! QrCode::backgroundColor(0,0,0,0)->color($qr_code_color, $qr_code_color, $qr_code_color)->size(100)->generate(url('profile', $user->username)); !!}
                    </div>
