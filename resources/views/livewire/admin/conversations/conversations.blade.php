            ...
            <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                ...
                <thead>
                    @forelse ($messages as $msg)
                        <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="admin-dashboard-messages-{{ $msg->id }}">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md object-cover lazy" src="{{ placeholder_img() }}" data-src="{{ src($msg->from->avatar) }}" alt="{{ $msg->from->username }}">
                            ...
                            <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md w-64 rtl:text-right">
                                <div class="flex items-center space-x-4 rtl:space-x-reverse">
                                    <img class="w-10 h-10 rounded-md object-cover lazy" src="{{ placeholder_img() }}" data-src="{{ src($msg->to->avatar) }}" alt="{{ $msg->to->username }}">
                                    <div class="space-y-1 font-medium dark:text-white">
                                        <div class="flex items-center space-x-1 rtl:space-x-reverse">
                        ...
                        {{-- View message --}}
                        <x-forms.modal id="modal-view-container-{{ $msg->id }}" target="modal-view-button-{{ $msg->id }}" uid="modal_msg_details_{{ $msg->id }}" placement="center-center" size="max-w-xl">
